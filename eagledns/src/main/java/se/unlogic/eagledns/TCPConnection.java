        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    log.debug(
                            "TCP query " + EagleDNS.toString(query.getQuestion()) + " from " + socket.getRemoteSocketAddress());
                ...
                log.debug(
                        "Error sending TCP response to " + socket.getRemoteSocketAddress() + ":" + socket.getPort() + ", " + e);
            ...
            log.warn("Error processing TCP connection from " + socket.getRemoteSocketAddress() + ":" + socket.getPort() + ", "
                    + e);
        }
    }
}
