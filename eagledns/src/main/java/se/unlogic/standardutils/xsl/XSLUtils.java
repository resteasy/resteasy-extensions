...
public class XSLUtils {
    ...
    /**
     * Scans XSL documents for references to XSL variables such as {@literal <}xsl:value-of select="$foo"/{@literal>} and
     * {@literal <}a href="{$foo}"/{@literal >}. Returns the variable names.
     *
