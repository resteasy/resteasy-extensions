...
public class ImageUtils {
    ...
    private static BufferedImage scale(BufferedImage image, double xFactor, double yFactor) {
        ...
        BufferedImage result = new BufferedImage((int) (image.getWidth() * xFactor), (int) (image.getHeight() * yFactor),
    ...
    /*
     * public static void scaleAndWriteImage(String inImgURL, String outImgURL, String format, double xFactor, double yFactor )
     * throws IOException{
     *
