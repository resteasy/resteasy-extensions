...
public class LogUtils {
    ...
    /**
     * A method for triggering the LogFactory.release method on the commons logging library (http://commons.apache.org/logging/)
     * without having compile time
     * dependency to the library itself. Trigger of the release method can be nessecary sometimes in order to avoid memory
     * leaks, see
