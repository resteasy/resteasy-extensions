 ...
 * <p>
 *
 * The parameters will be set on the prepared statement using the "class -> method mapping" in the
 * {@link PreparedStatementQueryMethods} class.<br>
 * Basically this means that any parameter that has a set method matching it's type in the {@link PreparedStatement} interface
 * will work.
 * <p>
 *
 *
