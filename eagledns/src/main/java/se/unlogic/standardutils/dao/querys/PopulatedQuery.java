...
public abstract class PopulatedQuery<ReturnType> extends PreparedStatementQuery {
    ...
    public PopulatedQuery(Connection connection, boolean closeConnectionOnExit, String query,
            BeanResultSetPopulator<? extends ReturnType> bp) throws SQLException {
        super(connection, closeConnectionOnExit, query);
        this.beanPopulator = bp;
    }

    public PopulatedQuery(DataSource dataSource, boolean closeConnectionOnExit, String query,
            BeanResultSetPopulator<? extends ReturnType> bp) throws SQLException {
