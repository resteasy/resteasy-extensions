...
public class BeanRelationPopulator<T> implements BeanResultSetPopulator<T> {
    ...
    public BeanRelationPopulator(BeanResultSetPopulator<T> populator, List<ManyToOneRelation<T, ?, ?>> manyToOneRelations,
            Connection connection, RelationQuery relationQuery) {
        super();
