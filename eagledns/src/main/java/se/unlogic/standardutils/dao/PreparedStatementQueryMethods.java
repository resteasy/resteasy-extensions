...
/**
 * This class provides a static map containing mappings from classes to their corresponding set methods in the
 * {@link PreparedStatement} interface.
 * <p>
 *
 * {@link Integer}, {@link Long}, {@link Double}, {@link Float}, {@link Boolean} and {@link Byte} types are mapped to the
 * setObject method in order to allow null values.
 * <p>
 *
    ...
    static {
        try {
            ...
            for (Method method : methods) {
                ...
                if (method.getName().startsWith("set") && !method.getName().equals("setObject")
                        && method.getParameterCount() == 2 && method.getParameterTypes()[0] == int.class) {
