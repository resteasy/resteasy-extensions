...
public class ExecUtils {
    ...
    /**
     * Executes the given command and waits for the resulting processes to terminate and all data written to standard out and
     * error out to be handled.
     * <p>
     *
     ...
     * @throws InterruptedException
     */
    public static int execAndWait(String command, StreamHandler stdOutHandler, StreamHandler errorOutHandler, Long timeout)
     ...
     * @throws InterruptedException
     */
    public static int execAndWait(String command, OutputStream outputStream, Long timeout)
            throws IOException, InterruptedException {
     ...
     * @throws InterruptedException
     */
    public static int execAndWait(ProcessBuilder builder, OutputStream outputStream, Long timeout)
            throws IOException, InterruptedException {
    ...
    public static int waitForProcessAndStreams(Process proc, StreamHandler stdOutHandler, StreamHandler errorOutHandler,
