...
public class FieldXMLInfo {
    ...
    public FieldXMLInfo(String name, Field field, FieldType fieldType, boolean cdata, boolean elementable, boolean list,
            boolean array, String childName, boolean skipSubElement, Stringyfier valueFormatter) {
